	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-5">
					<ul class="list-group">
						<li class="list-group-item productDetail-header"><h2
								class="text-white">${PRODUCT_DETAIL.name }</h2></li>
						<li class="list-group-item"><h3 style="color: #D10024">$${PRODUCT_DETAIL.price
								}</h3></li>
						<li class="list-group-item"></li>
						<li class="list-group-item"><p>Lorem ipsum dolor sit
								amet, consectetur adipisicing elit, sed do eiusmod tempor
								incididunt ut labore et dolore magna aliqua. Ut enim ad minim
								veniam, quis nostrud exercitation ullamco laboris nisi ut
								aliquip ex ea commodo consequat.</p></li>
						<li class="list-group-item">
							<form action="/shoppingCart/add" method="">
									...
									<div class="add-to-cart" style="margin-bottom: 0;">
										<div class="qty-label">
											...
											<div class="input-number">
												...
												<input type="number" name="qty" value = "1" /> <span class="qty-up">+</span>
